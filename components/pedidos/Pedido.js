...
const Pedido = ({ pedido }) => {
    ...
    //Modificar color del pedido en dependencia del estado 
    const clasePedido = () => {
    ...
    return (
        <div className={`${clase} border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-2 md:gap-4 shadow-lg`}>
            <div>
                ...
                {
                    email && (
                        <p className='text-black flex items-center my-2'>
                ...
                <h2 className='font-bold text-gray-800 mt-10'>Estado Pedido: {/*estadoPedido*/}</h2>
