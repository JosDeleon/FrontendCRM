        ...
        <aside className="bg-gray-800 sm:w-1/3 xl:w-1/5 sm:min-h-screen p-5">
            ...
            <nav className="mt-5 list-none">
                <li className={router.pathname === "/" ? "bg-blue-800 p-2" : "p-2"}>
                    <Link href="/" className="text-white  block text-xl">
                        Clientes
                    </Link>
                </li>
                <li className={router.pathname === "/pedidos" ? "bg-blue-800 p-2" : "p-2"}>
                    <Link href="/pedidos" className="text-white  block text-xl">
                        Pedidos
                    </Link>
                </li>
                <li className={router.pathname === "/productos" ? "bg-blue-800 p-2" : "p-2"}>
                    <Link href="/productos" className="text-white  block text-xl">
                        Productos
                    </Link>
                </li>
            </nav>
            ...
            <nav className="mt-5 list-none">
                <li className={router.pathname === "/mejoresvendedores" ? "bg-blue-800 p-2" : "p-2"}>
                    <Link href="/mejoresvendedores" className="text-white  block text-xl">
                        Mejores Vendedores
                    </Link>
                </li>
                <li className={router.pathname === "/mejoresclientes" ? "bg-blue-800 p-2" : "p-2"}>
                    <Link href="/mejoresclientes" className="text-white  block text-xl">
                        Mejores Clientes
                    </Link>
                </li>
            </nav>
